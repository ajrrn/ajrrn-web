...
## Línea A — Derechos humanos y gobernanza digital de las fronteras

Utiliza el derecho internacional de los derechos humanos para estudiar y criticar las tecnologías de control fronterizo: toma automatizada de decisiones, elaboración de perfiles de riesgo, detección de mentiras, biometría y drones. Entre las áreas de interés preliminares se encuentran el impacto de las tecnologías fronterizas en las personas LGBTQ+ desplazadas; la vigilancia lejos de las fronteras físicas; la participación del sector privado en la tecnología fronteriza; las dimensiones laborales y ecológicas de la economía de la IA aplicada al control fronterizo; los litigios y la supervisión; y el uso de las normas de no discriminación para cuestionar las fronteras digitales.
