...
- [x] Events: the 22 Sept 2026 launch entry ("AJRRN Town Hall: Kick-Off Event") carries the Zoom join link, meeting ID, passcode, Canadian dial-in numbers and SIP address (2026-09-21).
