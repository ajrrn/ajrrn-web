...
- [x] `publications/` — first real entry (Bill C‑2 consultation report, 2025); placeholders removed.
- [ ] Still placeholders: `opportunities/` (3 sample entries), `projects/` (2 sample entries). Replace them with real items — or delete them, in which case the list pages show a "nothing here yet" note.
